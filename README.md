...
- **👥 Пользователи** - управление пользователями, поиск, просмотр списков
- **💰 Баланс** - пополнение, списание, установка балансов
- **🔧 Подписки** - активация, деактивация, продление подписок
- **📢 Рассылка** - массовая рассылка сообщений
- **⚙️ Marzban** - настройки и статистика Marzban API
- **📈 Аналитика** - детальная аналитика и отчеты
- **🔒 Безопасность** - настройки безопасности

### Использование админ панели:
1. Добавьте свой Telegram ID в список администраторов в `bot/handlers/admin_handler.py`
2. Отправьте команду `/admin` в боте
3. Используйте интерактивное меню для управления

### Демонстрация:
```bash
# Показать возможности админ панели
python3 demo_admin.py
