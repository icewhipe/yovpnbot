#!/usr/bin/env python3
"""
Скрипт для обновления .env файла с токеном Marzban
"""

import os

def update_env_with_token():
    """Обновить .env файл с токеном Marzban"""
    print("=" * 60)
    print("ОБНОВЛЕНИЕ .ENV ФАЙЛА С ТОКЕНОМ MARZBAN")
    print("=" * 60)
    ...
    print(f"MARZBAN_API_URL: {new_values['MARZBAN_API_URL']}")
    
    # Marzban Admin Token
    new_values['MARZBAN_ADMIN_TOKEN'] = input("Введите MARZBAN_ADMIN_TOKEN (из Swagger UI): ").strip()
