...
class MenuKeyboards:
    ...
    def get_main_menu() -> InlineKeyboardMarkup:
        """
        Главное меню - современный минималистичный дизайн 2025-2026
        
        Структура (UX-тренды):
        - Крупные акцентные кнопки для ключевых действий (1 в ряд)
        - Компактные кнопки для вспомогательных функций (2 в ряд)
        - Чистые эмодзи без перегрузки
        - Понятные короткие названия
        """
        keyboard = [
            # 🎯 Основные действия - акцентные кнопки (1 в ряд)
            [
            ...
            # 💡 Дополнительные функции - компактно (2 в ряд)
            [
                InlineKeyboardButton(
                    text="🎁 Рефералы",
            ...
            # ⚙️ Сервисные функции - внизу (2 в ряд)
            [
                InlineKeyboardButton(
                    text="⚙️ Настройки",
